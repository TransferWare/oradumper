...
static
void
check_value_info(value_info_t *value_info)
{
  ...
  DBUG_PRINT("info", ("value_count: %u; array_count: %u; descr: %p; size: %p; align: %p; buf: %p; data: %p; ind: %p; returned_length: %p",
